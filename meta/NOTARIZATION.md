# PLMRS — NOTARIZATION.md

This file records external timestamping / notarization events for the PLMRS open release.
...
Only the file listed there is considered canonical for v1.0.
...
2. Save the resulting `.ots` receipt file into a suitable path, for example:
   ...
   - `meta/ots_receipts/PLMRS_HASHES_v1.0.ots`
...
- *(placeholder — fill after notarization)*  
  ...
  - Receipt path: `meta/ots_receipts/PLMRS_HASHES_v1.0.ots`
